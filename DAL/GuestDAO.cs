...
namespace DAL
{
    ...
    public void CreateGuest(GuestDM guest)
    {
       ...
       new SqlParameter("@Zip",guest.Zipcode)
       };
        dataWriter.Write(parameters, "CreateGuest");
        logs.LogError("Event", "An Guest has been added to the database", "Class:GuestDAO, Method:CreateGuest");
    ...
    public void UpdateGuest(GuestDM guest)
    {
       ...
       new SqlParameter("@Zip",guest.Zipcode)
        ...
        dataWriter.Write(parameters, "UpdateGuest");
        logs.LogError("Event", "An Guest has been Updated ", "Class:GuestDAO, Method:UpdateGuest");
      ...
      public void deleteGuestById(String id)
    {
        ...
        dataWriter.Write(parameters, "DeleteGuest");
        logs.LogError("Event", "An Guest has been removed from the database", "Class:GuestDAO, Method:DeleteGuestById");
    }
